...
urlpatterns = [
	...
	url(r'^output/$', views.outputEvents, name='output'),
	url(r'^pass_change/$', views.change_pass, name='pass'),
	url(r'^phone_input/$', views.change_phone, name='phone'),
	...
	url(r'^(?P<pk>[0-9]+)/duplicate/$', views.dup_event, name = 'event-dup'),
	url(r'^(?P<pk>[0-9]+)/delete/$', views.delete_event, name = 'delete'),
	url(r'^(?P<pk>[0-9]+)/studentdelete/$', views.delete_student, name = 'stud-delete'),
